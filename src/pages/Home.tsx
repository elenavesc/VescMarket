    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-100 py-16 px-4">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-2xl mb-4 font-light tracking-wider">ÚNETE A NUESTRA NEWSLETTER</h2>
          <p className="mb-6 text-gray-600">Recibe nuestras novedades y ofertas especiales.</p>
      ...
      <footer className="bg-white py-12 px-4 border-t border-gray-200">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-sm font-bold mb-4">AYUDA</h3>
            <ul className="space-y-2 text-sm">
              <li><Link to="/faq" className="hover:underline">Preguntas frecuentes</Link></li>
              <li><Link to="/shipping" className="hover:underline">Envíos y entregas</Link></li>
              <li><Link to="/returns" className="hover:underline">Devoluciones</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/aboutUs" className="hover:underline">Sobre nosotros</Link></li>
              <li><Link to="/stores" className="hover:underline">Nuestras tiendas</Link></li>
              <li><Link to="/sustainability" className="hover:underline">Sostenibilidad</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-sm font-bold mb-4">POLÍTICAS</h3>
            <ul className="space-y-2 text-sm">
          ...
          <div>
            <h3 className="text-sm font-bold mb-4">SÍGUENOS</h3>
            <div className="flex space-x-4">
              ...
              <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-600">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-600">
        ...
        <div className="mt-12 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} VESC. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
